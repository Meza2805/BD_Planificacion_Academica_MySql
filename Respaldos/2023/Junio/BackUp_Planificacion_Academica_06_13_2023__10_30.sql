...
begin
	...
	set CodigoBloque = (select ID from horario_designado where TimeBegin = RTRIM(LTRIM(h01)) and TimeEnd = RTRIM(LTRIM(h02)) );
...
-- Dump completed on 2023-06-13 22:30:16

...
b.TIEMPO_DESIGNADO AS HORARIO_BLOQUE ,a.ID AS CODIGO_ASIGNATURA, a.DESCRIPCION as ASIGNATURA , p.CEDULA as CEDULA_DOCENTE, concat(p.PRIMER_NOMBRE," ", p.PRIMER_APELLIDO) AS DOCENTE 
